...
pub(crate) fn capabilities(args: &[String]) -> CliResult<Value> {
    ...
    Ok(json!({
        ...
        "objectKindsIndex": {
            ...
            "module": ["ooxml vba build-bin", "ooxml vba create", "ooxml vba inspect", "ooxml vba extract-bin", "ooxml vba inspect-bin", "ooxml vba list", "ooxml vba extract", "ooxml vba add-module", "ooxml vba replace-module", "ooxml vba remove-module", "ooxml vba office-check", "ooxml vba attach", "ooxml vba remove"]
        },
        "exitCodes": [
