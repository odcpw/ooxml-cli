...
pub(super) fn command_specs() -> Vec<super::CommandSpec> {
    vec![
        ...
        spec(
            ...
            &["pptx", "scaffold"],
            "scaffold <output.pptx> (or --out <output.pptx>) [--brand <brand.json>]",
        ...
        spec(
            PptxCommandId::TextMeasure,
            &["pptx", "text", "measure"],
            "text measure <file> --slide <n> --target <selector>",
            "Estimate wrapped line count and text height using embedded per-font advance metrics",
            &["slide", "shape", "style"],
            vec![
                flag("--slide", "slide", "int", "1-based slide number"),
                flag(
            ...
            inspect("read-only text measurement debug surface"),
            None,
        ),
        spec(
