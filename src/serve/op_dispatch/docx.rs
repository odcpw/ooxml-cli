...
use crate::{
    ...
    docx_blocks_replace, docx_headers_footers_set_text, docx_styles_apply, json_bool, json_i64,
    json_optional_string, normalize_docx_header_footer_show_type, normalize_docx_style_target,
    require_docx_block_hash, resolve_required_docx_table_text,
};
