...
pub(crate) fn capabilities(args: &[String]) -> CliResult<Value> {
    ...
    Ok(json!({
        ...
        "objectKindsIndex": {
            ...
            "table": ["ooxml pptx tables show", "ooxml xlsx tables list", "ooxml xlsx tables show", "ooxml xlsx tables export", "ooxml xlsx tables append-rows", "ooxml xlsx tables append-records", "ooxml docx tables show", "ooxml docx tables set-cell", "ooxml docx tables clear-cell", "ooxml docx styles apply"],
