...
pub(super) fn command_specs() -> Vec<CommandSpec> {
    vec![
        ...
        spec(
            ...
            &["capabilities"],
            "capabilities [--for <filter>|--schema <name>|--workflows]",
            ...
            vec![
                ...
                flag(
                    ...
                    "workflows",
                    "bool",
                    "print only the generated runnable recipe catalog",
                ),
            ],
        ),
        spec(
            ...
            &["agent-triage"],
            "agent-triage [--file <file>] [--request <text>]",
            "Emit one-call agent triage JSON with family- and request-aware runnable recipe links, quick refs, health, discovery filters, and safe next actions.",
            &[],
            ...
            vec![
                flag(
                    ...
                    "file",
                    "string",
                    "detect the OOXML family from this file path and prioritize matching recipes",
                ),
                flag(
                    "--request",
                    "request",
                    "string",
                    "prioritize recipes that match this natural-language request",
                ),
            ],
        ),
        spec(
        ...
        spec(
            CoreCommandId::RobotDocsRecipes,
            &["robot-docs", "recipes"],
            "robot-docs recipes",
            "Print the generated runnable recipe catalog with exact commands, expected fields, and proof commands.",
            &[],
            direct("read-only documentation command"),
            vec![],
        ),
        spec(
            CoreCommandId::RobotDocsRecipe,
            &["robot-docs", "recipe"],
            "robot-docs recipe <name>",
            "Print one generated runnable recipe by its stable name.",
            &[],
            direct("read-only documentation command"),
            vec![],
        ),
        ...
        spec(
            CoreCommandId::Render,
            &["render"],
            "render <file> --out <dir> [--dpi <dpi>] [--pages <selection>] [--sheet <selector>]",
            "Render a PPTX, XLSX, or DOCX package to PDF and PNG pages through LibreOffice.",
            &["package", "slide", "sheet"],
            direct("read-only local rendering command; not a serve/MCP mutation op"),
            vec![
                ...
                flag(
                    ...
                    "sheet",
                    "string",
                    "XLSX worksheet selector; only the selected sheet is rendered",
                ),
        ...
        spec(
            ...
            "Compare two OOXML packages semantically, with optional visual render diff.",
            &["package"],
            ...
            vec![
                flag(
                    ...
                    "render",
                    "bool",
                    "enable visual diff via rendered page or slide images",
                ),
                flag(
                    "--threshold",
                    "threshold",
                    "float",
                    "maximum changed-pixel ratio for --render",
                ),
                flag(
                    "--out",
                    "out",
