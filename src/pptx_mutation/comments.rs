...
use self::output::{add_comment_result_json, edit_comment_result_json, remove_comment_result_json};
...
fn write_comment_mutation(
    ...
    let write_path = crate::mutation_staging_path(file, output_path, "pptx-comments");
