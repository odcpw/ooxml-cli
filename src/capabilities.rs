...
pub(crate) fn capabilities(args: &[String]) -> CliResult<Value> {
    ...
    Ok(json!({
        ...
        "commands": commands,
        "objectKinds": ["package", "template", "slide", "shape", "animation", "master", "layout", "placeholder", "sheet", "range", "data-validation", "cell", "hyperlink", "table", "pivot", "name", "block", "paragraph", "style", "comment", "chart", "field", "header", "footer", "image", "media", "module"],
        "objectKindsIndex": {
            "package": ["ooxml inspect", "ooxml validate", "ooxml verify", "ooxml apply", "ooxml docx text", "ooxml xlsx workbook metadata inspect", "ooxml xlsx workbook metadata update", "ooxml vba create", "ooxml vba inspect", "ooxml vba extract-bin", "ooxml vba inspect-bin", "ooxml vba list", "ooxml vba extract", "ooxml vba add-module", "ooxml vba replace-module", "ooxml vba remove-module", "ooxml vba attach", "ooxml vba remove"],
            "template": ["ooxml template tokens", "ooxml template profile save", "ooxml template profile inspect", "ooxml pptx template inspect", "ooxml pptx template capture", "ooxml pptx xlsx-bindings plan"],
            ...
            "master": ["ooxml pptx masters list", "ooxml pptx masters show", "ooxml pptx masters add-placeholder", "ooxml pptx fields inspect", "ooxml pptx fields set", "ooxml pptx extract xml"],
            ...
            "module": ["ooxml vba create", "ooxml vba inspect", "ooxml vba extract-bin", "ooxml vba inspect-bin", "ooxml vba list", "ooxml vba extract", "ooxml vba add-module", "ooxml vba replace-module", "ooxml vba remove-module", "ooxml vba office-check", "ooxml vba attach", "ooxml vba remove"]
        },
        "exitCodes": [
