...
use crate::{
    ...
    render_xml_attrs, xlsx_sheet_data_span, xlsx_used_range_from_cell_refs, zip_text,
};
...
pub(crate) fn xlsx_ranges_set_format(
    ...
    let readback_path = crate::mutation_staging_path(file, output_path, "xlsx-format");
