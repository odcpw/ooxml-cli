...
pub(crate) use xlsx_charts::{
    ...
    XlsxChartSetTitleOptions, xlsx_charts_list, xlsx_charts_set_chart_area_fill,
    xlsx_charts_set_legend, xlsx_charts_set_plot_area_fill, xlsx_charts_set_series_style,
    xlsx_charts_set_title, xlsx_charts_show,
};
