...
pub(crate) fn capabilities(args: &[String]) -> CliResult<Value> {
    ...
    Ok(json!({
        ...
        "commands": commands,
        "objectKinds": ["package", "template", "slide", "shape", "animation", "master", "layout", "placeholder", "sheet", "range", "data-validation", "cell", "hyperlink", "table", "pivot", "name", "block", "paragraph", "style", "theme", "comment", "chart", "field", "header", "footer", "image", "media", "module"],
        "objectKindsIndex": {
            ...
            "template": ["ooxml template tokens", "ooxml template profile save", "ooxml template profile inspect", "ooxml pptx template inspect", "ooxml pptx template capture", "ooxml pptx xlsx-bindings plan", "ooxml pptx xlsx-bindings apply"],
