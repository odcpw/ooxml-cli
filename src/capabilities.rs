...
pub(crate) fn capabilities(args: &[String]) -> CliResult<Value> {
    ...
    Ok(json!({
        ...
        "objectKindsIndex": {
            ...
            "chart": ["ooxml pptx charts list", "ooxml pptx charts show", "ooxml pptx charts set-title", "ooxml pptx charts set-legend", "ooxml pptx charts set-chart-area-fill", "ooxml pptx charts set-plot-area-fill", "ooxml pptx charts set-series-style", "ooxml pptx charts set-axis", "ooxml pptx charts convert-type", "ooxml pptx charts copy-style", "ooxml xlsx charts list", "ooxml xlsx charts show", "ooxml xlsx charts create", "ooxml xlsx charts update-source", "ooxml xlsx charts set-title", "ooxml xlsx charts set-legend", "ooxml xlsx charts set-chart-area-fill", "ooxml xlsx charts set-plot-area-fill", "ooxml xlsx charts set-series-style", "ooxml xlsx charts convert-type", "ooxml xlsx charts copy-style", "ooxml xlsx charts set-axis"],
