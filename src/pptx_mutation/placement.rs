...
use crate::{
    ...
    attr, check_range_max_cells, command_arg, copy_zip_with_binary_part_overrides_and_removals,
...
fn table_from_xlsx_destination(
    table: &Value,
    request: &TableRequest,
...
fn place_table_result_json(mutation: &TableMutation) -> Value {
    json!({
...
fn place_table_from_xlsx_result_json(
    file: &str,
