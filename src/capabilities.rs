...
pub(crate) fn capabilities(args: &[String]) -> CliResult<Value> {
    ...
    Ok(json!({
        ...
        "objectKindsIndex": {
            ...
            "chart": ["ooxml pptx charts list", "ooxml pptx charts show", "ooxml xlsx charts list"],
            ...
            "style": ["ooxml xlsx ranges set-format", "ooxml xlsx ranges set-style", "ooxml docx styles list", "ooxml docx styles show", "ooxml docx styles apply"],
