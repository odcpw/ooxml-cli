...
pub(crate) fn capabilities(args: &[String]) -> CliResult<Value> {
    ...
    Ok(json!({
        ...
        "commands": commands,
        "objectKinds": ["package", "template", "slide", "shape", "animation", "master", "layout", "placeholder", "sheet", "range", "form", "conditional-format", "data-validation", "cell", "hyperlink", "table", "pivot", "name", "block", "paragraph", "style", "theme", "comment", "chart", "field", "header", "footer", "image", "media", "module"],
        "objectKindsIndex": {
