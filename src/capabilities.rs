...
pub(crate) fn capabilities(args: &[String]) -> CliResult<Value> {
    ...
    Ok(json!({
        ...
        "objectKindsIndex": {
            ...
            "sheet": ["ooxml xlsx sheets list", "ooxml xlsx sheets show", "ooxml xlsx sheets add", "ooxml xlsx sheets rename", "ooxml xlsx sheets move", "ooxml xlsx sheets delete", "ooxml xlsx colwidths show", "ooxml xlsx colwidths set", "ooxml xlsx rowheights show", "ooxml xlsx rowheights set", "ooxml xlsx rows insert", "ooxml xlsx rows delete", "ooxml xlsx cols insert", "ooxml xlsx cols delete", "ooxml xlsx filters-sorts show", "ooxml xlsx filters-sorts set-autofilter", "ooxml xlsx filters-sorts clear-autofilter", "ooxml xlsx filters-sorts add-column-filter", "ooxml xlsx filters-sorts clear-column-filter", "ooxml xlsx filters-sorts set-sort", "ooxml xlsx filters-sorts clear-sort", "ooxml xlsx comments list", "ooxml xlsx comments add", "ooxml xlsx comments update", "ooxml xlsx comments remove", "ooxml xlsx data-validations list", "ooxml xlsx data-validations show", "ooxml xlsx data-validations create", "ooxml xlsx data-validations update", "ooxml xlsx data-validations delete", "ooxml xlsx hyperlinks list", "ooxml xlsx hyperlinks show", "ooxml xlsx hyperlinks add", "ooxml xlsx hyperlinks update", "ooxml xlsx hyperlinks delete", "ooxml xlsx ranges export", "ooxml xlsx ranges set", "ooxml xlsx ranges set-format", "ooxml xlsx cells extract", "ooxml xlsx cells set", "ooxml xlsx freeze show", "ooxml xlsx freeze set", "ooxml xlsx freeze clear", "ooxml xlsx tables list", "ooxml xlsx tables show", "ooxml xlsx tables export", "ooxml xlsx tables append-rows", "ooxml xlsx tables append-records", "ooxml xlsx names list", "ooxml xlsx names show", "ooxml xlsx names add", "ooxml xlsx names update", "ooxml xlsx names rename", "ooxml xlsx names delete"],
            "range": ["ooxml xlsx colwidths show", "ooxml xlsx colwidths set", "ooxml xlsx rowheights show", "ooxml xlsx rowheights set", "ooxml xlsx rows insert", "ooxml xlsx rows delete", "ooxml xlsx cols insert", "ooxml xlsx cols delete", "ooxml xlsx filters-sorts show", "ooxml xlsx filters-sorts set-autofilter", "ooxml xlsx filters-sorts clear-autofilter", "ooxml xlsx filters-sorts add-column-filter", "ooxml xlsx filters-sorts clear-column-filter", "ooxml xlsx filters-sorts set-sort", "ooxml xlsx filters-sorts clear-sort", "ooxml xlsx data-validations list", "ooxml xlsx data-validations show", "ooxml xlsx data-validations create", "ooxml xlsx data-validations update", "ooxml xlsx data-validations delete", "ooxml xlsx hyperlinks list", "ooxml xlsx hyperlinks show", "ooxml xlsx hyperlinks add", "ooxml xlsx hyperlinks update", "ooxml xlsx hyperlinks delete", "ooxml xlsx ranges export", "ooxml xlsx ranges set", "ooxml xlsx ranges set-format", "ooxml xlsx cells extract", "ooxml xlsx tables list", "ooxml xlsx tables show", "ooxml xlsx tables export", "ooxml xlsx tables append-rows", "ooxml xlsx tables append-records", "ooxml xlsx names list", "ooxml xlsx names show", "ooxml xlsx names add", "ooxml xlsx names update", "ooxml xlsx names rename", "ooxml xlsx names delete"],
            ...
            "cell": ["ooxml xlsx comments list", "ooxml xlsx comments add", "ooxml xlsx comments update", "ooxml xlsx comments remove", "ooxml xlsx hyperlinks list", "ooxml xlsx hyperlinks show", "ooxml xlsx hyperlinks add", "ooxml xlsx hyperlinks update", "ooxml xlsx hyperlinks delete", "ooxml xlsx ranges set", "ooxml xlsx cells set"],
