...
use crate::{
    CliError, CliResult, attr_exact, copy_zip_with_part_overrides, local_name, package_type,
...
fn write_theme_mutation(
    ...
    let write_path = crate::mutation_staging_path(file, output_path, "pptx-theme");
