...
pub(super) fn unique_sorted_warnings(warnings: Vec<String>) -> Vec<String> {
    warnings
        .into_iter()
...
pub(super) struct ChartCreateResultInput<'a> {
    pub(super) file: &'a str,
    pub(super) output_path: Option<&'a str>,
    pub(super) dry_run: bool,
    pub(super) slide: i64,
    pub(super) create: &'a CreateSlideChartResult,
    pub(super) source: &'a ChartCreateSource,
    pub(super) geometry: &'a ChartGeometry,
    pub(super) chart: Value,
}

pub(super) fn chart_create_result_json(input: ChartCreateResultInput<'_>) -> Value {
...
pub(super) struct ChartUpdateDataResultInput<'a> {
    pub(super) file: &'a str,
    pub(super) output_path: Option<&'a str>,
    pub(super) dry_run: bool,
    pub(super) slide: i64,
    ...
    pub(super) chart: Value,
    pub(super) selected: &'a SelectedChart,
    pub(super) updated_roles: Vec<UpdatedRoleResult>,
    pub(super) embedded_updated: bool,
    pub(super) current_values_hash: &'a str,
    pub(super) expect_values_hash: &'a str,
    pub(super) warnings: Vec<String>,
}

pub(super) fn chart_update_data_result_json(input: ChartUpdateDataResultInput<'_>) -> Value {
...
pub(super) fn updated_role_result_json(role: &UpdatedRoleResult) -> Value {
...
pub(super) fn add_pptx_chart_create_commands(
...
pub(super) fn add_pptx_chart_update_commands(
    result: &mut Map<String, Value>,
    output_path: Option<&str>,
    dry_run: bool,
    slide: i64,
...
pub(super) fn pptx_chart_show_command(file: &str, slide: i64, selector: &str) -> String {
...
pub(super) fn pptx_charts_list_command(file: &str, slide: i64) -> String {
...
pub(super) fn pptx_validate_command(file: &str) -> String {
    format!("ooxml validate --strict {}", command_arg(file))
}

pub(super) fn pptx_render_command(file: &str) -> String {
