...
- Last setup checks:
  ...
  - `cargo test --all-targets` passed with 4 unit tests and 209 Rust contract
    tests after the hidden conformance ZIP-timestamp, reference-list, and
    deep-relationship invariant slices.
