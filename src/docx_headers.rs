...
use selectors::{
    ...
    docx_header_footer_ref_info_from_parts, parse_docx_header_footer_selector,
...
use crate::{
    ...
    xml_attr_escape, xml_direct_child_ranges, xml_fragment_bounds, xml_open_tag_from_start,
    xml_tag_prefix, zip_entry_names, zip_text,
};
