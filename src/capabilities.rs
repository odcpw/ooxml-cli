...
pub(crate) fn capabilities(args: &[String]) -> CliResult<Value> {
    ...
    Ok(json!({
        ...
        "commands": commands,
        "objectKinds": ["package", "slide", "shape", "master", "layout", "placeholder", "sheet", "range", "data-validation", "cell", "table", "name", "block", "paragraph", "style", "comment", "field", "header", "footer", "image", "module"],
        "objectKindsIndex": {
