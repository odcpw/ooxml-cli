...
pub(super) fn command_specs() -> Vec<super::CommandSpec> {
    vec![spec(
        ...
        &["pptx", "render"],
        "render <file>",
        "Render a PPTX to PDF and PNG pages when local tools are installed.",
        &["slide"],
        vec![
            ...
            flag(
                ...
                "dpi",
                "integer",
                "PNG raster resolution; defaults to 144",
            ),
            flag(
                "--pages",
                "pages",
                "string",
                "comma-separated pages or ranges, for example 1-3,5",
            ),
