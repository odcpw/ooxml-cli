...
use crate::{
    ...
    add_relationship_to_xml, add_selector, allocate_relationship_id, attr, col_name, command_arg,
...
#[derive(Clone, Default)]
struct XlsxPivotCacheRef {
    cache_id: i32,
    part_uri: String,
    relationship_id: String,
    records_part_uri: String,
    record_count: i32,
    created_version: String,
    refreshed_version: String,
    refresh_on_load: bool,
    save_data: Option<bool>,
    source: XlsxPivotSourceRef,
    fields: Vec<XlsxPivotCacheField>,
}

impl XlsxPivotCacheRef {
    fn field_name(&self, index: i32) -> String {
        self.fields
            .iter()
...
struct XlsxPivotRef {
    ...
    row_fields: Vec<XlsxPivotFieldRef>,
    column_fields: Vec<XlsxPivotFieldRef>,
    data_fields: Vec<XlsxPivotFieldRef>,
    filter_fields: Vec<XlsxPivotFieldRef>,
    fields: Vec<XlsxPivotFieldRef>,
}
...
struct PivotFieldModel {
    name: String,
    numeric: bool,
    has_items: bool,
    items: Vec<String>,
    item_is_num: Vec<bool>,
...
struct PivotCreateArtifacts {
    ...
    location: String,
    cache_id: i32,
    cache_definition_uri: String,
    cache_records_uri: String,
    pivot_table_uri: String,
    row_fields: Vec<String>,
    col_fields: Vec<String>,
