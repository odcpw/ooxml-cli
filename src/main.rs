...
fn capabilities(args: &[String]) -> CliResult<Value> {
    ...
    Ok(json!({
        ...
        "commands": commands,
        "objectKinds": ["package", "slide", "shape", "layout", "placeholder", "sheet", "range", "cell", "table", "block", "paragraph", "style", "comment", "field", "header", "footer", "image"],
        "objectKindsIndex": {
            ...
            "placeholder": ["ooxml pptx layouts list", "ooxml pptx layouts show"],
