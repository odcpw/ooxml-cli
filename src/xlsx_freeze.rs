...
use crate::{
    ...
    normalize_xl_target, relationships, remove_xml_span, render_xml_attrs, replace_xml_span,
    resolve_sheet, validate_xlsx_mutation_output_flags, workbook_sheets, xml_attrs,
...
fn run_freeze_mutation(
    ...
    let readback_path = crate::mutation_staging_path(file, output_path, "xlsx-freeze");
