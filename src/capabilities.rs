...
pub(crate) fn capabilities(args: &[String]) -> CliResult<Value> {
    ...
    Ok(json!({
        ...
        "objectKindsIndex": {
            ...
            "shape": ["ooxml pptx slides list", "ooxml pptx slides selectors", "ooxml pptx slides show", "ooxml pptx shapes show", "ooxml pptx shapes get", "ooxml pptx shapes set-bounds", "ooxml pptx shapes delete", "ooxml pptx layouts set-bounds", "ooxml pptx layouts delete-shape", "ooxml pptx extract text", "ooxml pptx replace text", "ooxml pptx replace text-occurrences", "ooxml pptx replace images"],
