...
pub(crate) fn capabilities(args: &[String]) -> CliResult<Value> {
    ...
    Ok(json!({
        ...
        "commands": commands,
        "objectKinds": ["package", "slide", "shape", "animation", "master", "layout", "placeholder", "sheet", "range", "data-validation", "cell", "hyperlink", "table", "pivot", "name", "block", "paragraph", "style", "comment", "chart", "field", "header", "footer", "image", "media", "module"],
        "objectKindsIndex": {
            ...
            "slide": ["ooxml pptx slides list", "ooxml pptx slides selectors", "ooxml pptx slides show", "ooxml pptx slides delete", "ooxml pptx slides move", "ooxml pptx slides reorder", "ooxml pptx clone-slide", "ooxml pptx new-slide-from-layout", "ooxml pptx shapes show", "ooxml pptx shapes get", "ooxml pptx add-textbox", "ooxml pptx place image", "ooxml pptx place table", "ooxml pptx place table-from-xlsx", "ooxml pptx shapes set-bounds", "ooxml pptx shapes delete", "ooxml pptx animations list", "ooxml pptx animations add", "ooxml pptx animations remove", "ooxml pptx animations reorder", "ooxml pptx animations prune-stale", "ooxml pptx layouts list", "ooxml pptx layouts show", "ooxml pptx tables show", "ooxml pptx tables set-cell", "ooxml pptx tables delete-row", "ooxml pptx tables insert-row", "ooxml pptx tables delete-col", "ooxml pptx tables insert-col", "ooxml pptx tables update-from-xlsx", "ooxml pptx charts list", "ooxml pptx charts show", "ooxml pptx charts set-title", "ooxml pptx charts set-legend", "ooxml pptx charts set-chart-area-fill", "ooxml pptx charts set-plot-area-fill", "ooxml pptx charts set-series-style", "ooxml pptx charts set-axis", "ooxml pptx charts convert-type", "ooxml pptx charts copy-style", "ooxml pptx extract text", "ooxml pptx extract notes", "ooxml pptx extract images", "ooxml pptx extract xml", "ooxml pptx media list", "ooxml pptx media add", "ooxml pptx media replace", "ooxml pptx notes show", "ooxml pptx notes set", "ooxml pptx notes clear", "ooxml pptx comments list", "ooxml pptx replace text", "ooxml pptx replace text-occurrences", "ooxml pptx replace text-from-xlsx", "ooxml pptx replace text-map-from-xlsx", "ooxml pptx replace images", "ooxml pptx render"],
            "shape": ["ooxml pptx slides list", "ooxml pptx slides selectors", "ooxml pptx slides show", "ooxml pptx shapes show", "ooxml pptx shapes get", "ooxml pptx add-textbox", "ooxml pptx place image", "ooxml pptx place table", "ooxml pptx place table-from-xlsx", "ooxml pptx shapes set-bounds", "ooxml pptx shapes delete", "ooxml pptx animations list", "ooxml pptx animations add", "ooxml pptx animations remove", "ooxml pptx animations prune-stale", "ooxml pptx layouts set-bounds", "ooxml pptx layouts delete-shape", "ooxml pptx extract text", "ooxml pptx replace text", "ooxml pptx replace text-occurrences", "ooxml pptx replace text-from-xlsx", "ooxml pptx replace text-map-from-xlsx", "ooxml pptx replace images", "ooxml pptx media replace"],
            ...
            "master": ["ooxml pptx masters list", "ooxml pptx masters show", "ooxml pptx masters add-placeholder", "ooxml pptx extract xml"],
            "layout": ["ooxml pptx new-slide-from-layout", "ooxml pptx layouts list", "ooxml pptx layouts show", "ooxml pptx layouts clone", "ooxml pptx layouts rename", "ooxml pptx layouts set-bounds", "ooxml pptx layouts delete-shape", "ooxml pptx layouts add-placeholder", "ooxml pptx extract xml"],
            ...
            "chart": ["ooxml pptx charts list", "ooxml pptx charts show", "ooxml pptx charts set-title", "ooxml pptx charts set-legend", "ooxml pptx charts set-chart-area-fill", "ooxml pptx charts set-plot-area-fill", "ooxml pptx charts set-series-style", "ooxml pptx charts set-axis", "ooxml pptx charts convert-type", "ooxml pptx charts copy-style", "ooxml xlsx charts list", "ooxml xlsx charts show", "ooxml xlsx charts set-title", "ooxml xlsx charts set-legend", "ooxml xlsx charts set-chart-area-fill", "ooxml xlsx charts set-plot-area-fill", "ooxml xlsx charts set-series-style", "ooxml xlsx charts convert-type", "ooxml xlsx charts copy-style", "ooxml xlsx charts set-axis"],
            "table": ["ooxml pptx place table", "ooxml pptx place table-from-xlsx", "ooxml pptx tables show", "ooxml pptx tables set-cell", "ooxml pptx tables delete-row", "ooxml pptx tables insert-row", "ooxml pptx tables delete-col", "ooxml pptx tables insert-col", "ooxml pptx tables update-from-xlsx", "ooxml xlsx filters-sorts show", "ooxml xlsx filters-sorts set-autofilter", "ooxml xlsx filters-sorts clear-autofilter", "ooxml xlsx tables list", "ooxml xlsx tables show", "ooxml xlsx tables export", "ooxml xlsx tables append-rows", "ooxml xlsx tables append-records", "ooxml xlsx tables set-column-format", "ooxml xlsx pivots list", "ooxml xlsx pivots show", "ooxml xlsx pivots create", "ooxml docx tables show", "ooxml docx tables set-cell", "ooxml docx tables clear-cell", "ooxml docx tables insert-row", "ooxml docx tables delete-row", "ooxml docx replace", "ooxml docx styles apply"],
            ...
            "style": ["ooxml pptx charts set-title", "ooxml pptx charts set-legend", "ooxml pptx charts set-chart-area-fill", "ooxml pptx charts set-plot-area-fill", "ooxml pptx charts set-series-style", "ooxml pptx charts set-axis", "ooxml pptx charts convert-type", "ooxml pptx charts copy-style", "ooxml xlsx charts set-title", "ooxml xlsx charts set-legend", "ooxml xlsx charts set-chart-area-fill", "ooxml xlsx charts set-plot-area-fill", "ooxml xlsx charts set-series-style", "ooxml xlsx charts copy-style", "ooxml xlsx charts set-axis", "ooxml xlsx ranges set-format", "ooxml xlsx ranges set-style", "ooxml xlsx tables set-column-format", "ooxml docx styles list", "ooxml docx styles show", "ooxml docx styles apply"],
            ...
            "image": ["ooxml pptx extract images", "ooxml pptx place image", "ooxml pptx replace images", "ooxml docx images list", "ooxml docx images replace", "ooxml docx images insert"],
