...
pub(crate) fn capabilities(args: &[String]) -> CliResult<Value> {
    ...
    Ok(json!({
        ...
        "objectKindsIndex": {
            ...
            "sheet": ["ooxml xlsx sheets list", "ooxml xlsx sheets show", "ooxml xlsx colwidths show", "ooxml xlsx rowheights show", "ooxml xlsx filters-sorts show", "ooxml xlsx filters-sorts set-autofilter", "ooxml xlsx filters-sorts clear-autofilter", "ooxml xlsx filters-sorts add-column-filter", "ooxml xlsx comments list", "ooxml xlsx comments add", "ooxml xlsx comments update", "ooxml xlsx comments remove", "ooxml xlsx ranges export", "ooxml xlsx ranges set", "ooxml xlsx ranges set-format", "ooxml xlsx cells extract", "ooxml xlsx cells set", "ooxml xlsx freeze show", "ooxml xlsx freeze set", "ooxml xlsx freeze clear", "ooxml xlsx tables list", "ooxml xlsx tables show", "ooxml xlsx tables export", "ooxml xlsx tables append-rows", "ooxml xlsx tables append-records", "ooxml xlsx names list", "ooxml xlsx names show", "ooxml xlsx names add", "ooxml xlsx names update", "ooxml xlsx names rename", "ooxml xlsx names delete"],
            "range": ["ooxml xlsx colwidths show", "ooxml xlsx rowheights show", "ooxml xlsx filters-sorts show", "ooxml xlsx filters-sorts set-autofilter", "ooxml xlsx filters-sorts clear-autofilter", "ooxml xlsx filters-sorts add-column-filter", "ooxml xlsx ranges export", "ooxml xlsx ranges set", "ooxml xlsx ranges set-format", "ooxml xlsx cells extract", "ooxml xlsx tables list", "ooxml xlsx tables show", "ooxml xlsx tables export", "ooxml xlsx tables append-rows", "ooxml xlsx tables append-records", "ooxml xlsx names list", "ooxml xlsx names show", "ooxml xlsx names add", "ooxml xlsx names update", "ooxml xlsx names rename", "ooxml xlsx names delete"],
