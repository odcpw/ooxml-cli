...
use crate::{
    ...
    resolve_relationship_target, xml_attrs, zip_bytes, zip_text,
};
...
fn check_chart_external_data_embedded_workbook_open(
    file: &str,
    part_uri: &str,
    label: &str,
    rid: &str,
...
fn is_embedded_spreadsheet_package_content_type(content_type: &str) -> bool {
    matches!(
